...
import com.example.ps4.Adapters.RecyclerViewAdapterReviewRestaurant;
...
public class RestaurantDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  if(prix.equals(0)){
        ...
        AddReservation.setOnClickListener(new RestaurantDetails.AddReservationButtonOnClickListener());
        floatingActionButton2 = findViewById(R.id.floatingActionButton2);
        floatingActionButton2.setOnClickListener(new RestaurantDetails.FeedbackButtonOnClickListener());
        ...
        price.setText("Depends on the meal !");
    ...
    protected void onStart() {
        ...
        reviewFirestoreManager.getAllReviews(new RestaurantDetails.GetAllReviewsOnCompleteListener(), document_id_endroit);
...
//
        ...
        private void populateReviewRecyclerView(List<Review> reviewList) {
            ...
            RecyclerViewAdapterReviewRestaurant reviewListMainRecyclerViewAdapter = new RecyclerViewAdapterReviewRestaurant(reviewList, new RestaurantDetails.GetAllReviewsOnCompleteListener.ReviewListRecyclerViewOnItemClickListener());
        ...
        public class ReviewListRecyclerViewOnItemClickListener implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(RestaurantDetails.this, RestaurantDetails.class);
    ...
    private class AddReservationButtonOnClickListener implements View.OnClickListener {
        public void onClick(View view) {
            ...
            type_endroit="restaurants";
            Intent intent = new Intent();
            intent.setClass(RestaurantDetails.this, ReservationRestaurantFormActivity.class);
            ...
            intent.putExtra(RestaurantFirestoreDB.FIELD_RESTAURANT_NAME, hotel_name);
            Log.d("restaudetails", "review size" +hotel_name);
         //   intent.putExtra(HotelsFirestoreDbContract.FIELD_PRIX, prix);
            intent.putExtra(RestaurantFirestoreDB.FIELD_DESCRIPTION, description);
            ...
            intent.putExtra(RestaurantFirestoreDB.FIELD_IMAGE_URL, imageurl);
    ...
    private class FeedbackButtonOnClickListener implements View.OnClickListener {
        public void onClick(View view) {
            ...
            Intent intent = new Intent();
            intent.setClass(RestaurantDetails.this, RatingForm.class);
