...
public class ReservationRestaurantFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reservation_restaurant_form);
        ...
        hotel_name = bundle.getString(RestaurantFirestoreDB.FIELD_RESTAURANT_NAME);
        ...
        okButtonn.setOnClickListener(new ReservationRestaurantFormActivity.OKButtonOnClickListener());
        mDisplayDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        ReservationRestaurantFormActivity.this,
...
*/
    ...
    private class OKButtonOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.setClass(ReservationRestaurantFormActivity.this, ReservationList.class);
